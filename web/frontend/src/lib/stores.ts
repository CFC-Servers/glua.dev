...
export const sessionMetadata = writable<{ branch: string; gameVersion: string; containerTag: string; startedAt: number } | null>(null);
export const sessionTimer = writable<{ endTime: number } | null>(null);
