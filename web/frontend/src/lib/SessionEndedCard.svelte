...
<div class="px-4 py-5 border-t border-gray-700/50 text-center">
    <p class="text-white font-semibold text-sm mb-1">Thanks for using glua.dev! 👋</p>
    <p class="text-gray-400 text-xs mb-4">Free forever, with 💖 from <a href="https://github.com/CFC-Servers" target="_blank" rel="noopener noreferrer" class="text-indigo-400 hover:text-indigo-300 hover:underline">CFC Servers</a></p>
